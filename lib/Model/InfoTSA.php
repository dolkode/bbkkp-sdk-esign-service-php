 ...
 */
class InfoTSA implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('tsa_cert_validity', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($tsa_cert_validity)) {
            array_push($this->openAPINullablesSetToNull, 'tsa_cert_validity');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('tsa_cert_validity', $nullablesSetToNull);
            if ($index !== FALSE) {
