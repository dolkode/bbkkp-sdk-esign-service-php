 ...
 */
class SignatureDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('info_tsa', $data ?? [], null);
        $this->setIfExists('signature_field', $data ?? [], null);
        $this->setIfExists('info_signer', $data ?? [], null);
        $this->setIfExists('signature_document', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($info_tsa)) {
            throw new \InvalidArgumentException('non-nullable info_tsa cannot be null');
        }
    ...
    {
        if (is_null($signature_field)) {
            throw new \InvalidArgumentException('non-nullable signature_field cannot be null');
        }
    ...
    {
        if (is_null($info_signer)) {
            throw new \InvalidArgumentException('non-nullable info_signer cannot be null');
        }
    ...
    {
        if (is_null($signature_document)) {
            throw new \InvalidArgumentException('non-nullable signature_document cannot be null');
        }
